...
import { faAngleLeft, faSquarePollVertical } from '@fortawesome/free-solid-svg-icons';
...
export default function QuizPage() {
  ...
  const handleOptionSelect = (index) => {
    ...
    if (selectedOption === null) {
      ...
      // Delay the next question by 2 seconds
      setTimeout(() => {
    ...
    <div  className="h-screen w-screen max-w-sm  m-auto shadow-lg shadow-black">
      <div className=" bg-gray-800 h-60 rounded-3xl pt-8 h-1/3 p-4 relative shadow-lg shadow-black">
        <div className="flex justify-between">
          ...
          <div className="cursor-pointer" onClick={() => navigate("/result")}>
            <FontAwesomeIcon icon={faSquarePollVertical} size="2xl" color="white" />
          </div>
        </div>
        <div className="flex">
